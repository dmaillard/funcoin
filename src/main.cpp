...
uint256 hashGenesisBlock("0x0a833f6dc1f120e6c9ea74077fbc31541d89169d8c7cdd8928aaf3fdbf56cb1b");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xac572b08d31b62a8cbf19f5ef2c3383db16ff995a00290157efecc4e0c2788d5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "NY Times 05/Oct/2011 Apple’s Visionary, Dies at 56";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0422ffbbccd860dd47ff92ef40507b70b9b32be8fd5ba1b4ad31bd508d7f46ffd5e8dc47b700a4e1209546ab5b694d2e00dc460ea237e2c4b7d8b151fb7efd0920") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1522899746;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088102934;

        if (fTestNet)
        {
            block.nTime    = 1522899723;
            block.nNonce   = 386322505;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x7bda1a478ef9fcd22226242114d3d43c1f4f407476dcc477c925e6478dfa4ac5"));
        block.print();
